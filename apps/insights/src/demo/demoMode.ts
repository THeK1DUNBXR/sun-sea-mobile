...
// on every single request) backed by AsyncStorage so a demo session survives
// an app restart the same way a real one would.

import AsyncStorage from '@react-native-async-storage/async-storage';

export const DEMO_MODE_STORAGE_KEY = 'sunsea.insights.demoMode';
